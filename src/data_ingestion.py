...
def ingest_data():
    try:
        ...
        #checking if training and testing data is present or not
        if os.path.exists(train_data_path) and os.path.exists(test_data_path):
            logger.debug("Train and test data files found, Exiting....")
            return

        #creating training and testing data if not present
        else:
            logger.info("Train and test data files not found")
